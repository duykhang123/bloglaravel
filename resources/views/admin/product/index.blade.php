            ...
            <div class="x_panel">
                <div class="zvn-add-new">
                    ...
                    <a href="#" onclick="javascript:submitForm('{{ route($controllerName . 'delete') }}')"
                        ...
                        Xóa</a>
                    <a href="#"
                        onclick="javascript:submitStatus('{{ route($controllerName . 'changePublish', ['status' => 1]) }}')"
                        class="btn btn-success"><i class="fa fa-unlock"></i>
                        Publish</a>
                    <a href="#"
                        onclick="javascript:submitStatus('{{ route($controllerName . 'changePublish', ['status' => 0]) }}')"
