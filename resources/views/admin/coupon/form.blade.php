@php
    ...
    $select_type = Form::select('form[type]', config('myconfig.template.coupon'), null, ['class' => 'form-control']);
@endphp
                    ...
                    <div class="x_content">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="form[code]" id="name"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="form[value]" id="name"
                                    class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
