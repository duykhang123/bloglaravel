@php
    ...
    $select_category = Form::select('form[category_id]', $arrCategory, $item['category_id'], ['class' => 'form-control']);
@endphp
                        ...
                        <div id="listTag">
                            ...
                            @foreach ($tags as $key => $tag)
                                <div class="checkbox">
                                    ...
                                    @endphp
                                    <label><input {{ $check }} name="tag_id[]" value="{{ $tag->id }}"
                                            type="checkbox">{{ $tag->name }}</label>
                                    <a href="javascript:removeTag('{{ route('admin.tag.removeTag') }}','{{$tag->id}})'">
