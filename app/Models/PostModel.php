...
class PostModel extends Model
{
    ...
    private $folderUpload = 'post';
    protected $fillable = [
        'name', 'description','tag_id' ,'content', 'status', 'category_id', 'picture', 'slug', 'meta_title', 'meta_description', 'meta_keyword', 'updated_at', 'created_at'
    ];
    private $fileImage = [
        'thumb' => ['width' => 150],
        'standard' => ['width' => 300],
    ...
    public function saveItem($params)
    {
        ...
        $post->tags()->attach($params['tag_id']);
    }
